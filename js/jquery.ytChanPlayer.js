...
(function ($) {
  "use strict";
	$.fn.ytChanPlayer = function (settings) {
		var $ytEl	= $(this),
			$ytPlayer,
			$ytList	= $('<div/>', {'class': 'yt-channel-list ui four items'}),
			options	= $.extend({}, {
			  username: '',
			  query: '',
			  startIndex: 1,
			  ...
			  if (options.sticky) {
				...
				for (i = 0; i < data.feed.entry.length; i++) {
					...
					vid = {
						...
						description: (e ? e.media$group.media$description.$t : ''),
					...
					html	= $('<div/>', {'class': 'yt-channel-video item'})
				    .html([
				           '<div class="image">',
					    ...
					    '</a>',
					    '<a class="star ui corner label"><i class="star icon"></i></a>',
					    '</div>',
					    '<div class="content">',
